...
![MPC](/assets/img/mpc.png){: width="250" height="300" .w-30 .shadow .rounded-10 .right}
...
![Signal](/assets/img/signal.jpg){: width="972" height="589" .w-50 .shadow .rounded-10 .right}
...
![Coinbase](/assets/img/coinbase.gif){: width="972" height="589" .w-50 .shadow .rounded-10 .right}
...
![ENPA](/assets/img/enpa.jpg){: width="972" height="589" .w-50 .shadow .rounded-10 .right}
...
![Divvi Up](/assets/img/divviupgraph.png){: .shadow .rounded-10}
_Divvi Up Information Flow Overview_
...
Hundreds of academic MPC papers simply state “Assume $n$ independent parties…” This brings us to the most daunting question when it comes to making MPC work in practice: Who are these parties in a real deployment?

In a high-stakes security application like Coinbase’s digital asset key management, it is of utmost importance to select parties that maintain sufficient *separation* between their computing environments. The greater the separation, the more difficult it would be for an attacker to compromise the entire signing key and generate a fraudulent transaction.

![Coinbase 2PC](/assets/img/coinbase2pc.png){: width="972" height="589" .w-50 .shadow .rounded-10 .right}
...
![ENPA](/assets/img/enpa-flow.png){: width="972" height="589" .w-50 .shadow .rounded-10 .right}
_The ENPA service flow and all involved parties_
...
![Divvi Up](/assets/img/divviup.png){: .shadow .rounded-10}
_Divvi Up information flow, where non-colluding servers are in distinct clouds_
...
![Enclave](/assets/img/enclave.png){: width="972" height="589" .w-50 .shadow .rounded-10 .right}
...
Similarly, Coinbase certainly utilizes cloud HSMs for key storage, as well as enclaves on mobile phones to encrypt users’ secret shares. However, it does not rely on enclaves alone. A general consensus among MPC deployers is that enclaves are an excellent *secondary* security measure when combined with MPC.
